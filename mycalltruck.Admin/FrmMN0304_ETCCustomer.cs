...
{
    public partial class FrmMN0304_ETCCustomer : Form
    {
...
//               SalesManage ON Orders.SalesManageId = SalesManage.SalesId";
            ...
            return @"SELECT  Orders.CreateTime, ISNULL(Orders.Customer, '') AS CustomerName, Orders.DriverCarNo, Orders.Driver, Orders.DriverPhoneNo, ISNULL(Orders.StartName, '') AS StartName, 
               ...
               Orders.OrderLine, Orders.OrderProduct, Orders.OrderTurn, Orders.OrderWidth, Orders.OrderLength, Orders.OrderHeight, Orders.AlterTradePrice, Orders.NTradePrice, Orders.NAlterTradePrice, 
               Orders.NPrice
FROM     Orders INNER JOIN
        ...
        private void grid1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            else if (e.ColumnIndex == referralNameDataGridViewTextBoxColumn.Index)
            {
        ...
        private void grid1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            FrmMDI.LoadForm("FrmMN0301_ETCCustomer", "Order", _SOrderId);
        }
