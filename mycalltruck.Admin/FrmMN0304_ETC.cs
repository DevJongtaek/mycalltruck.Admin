...
{
    public partial class FrmMN0304_ETC : Form
    {
        ...
        {
            // TODO: 이 코드는 데이터를 'nSTATSDataSet.NSTATS1ETC' 테이블에 로드합니다. 필요 시 이 코드를 이동하거나 제거할 수 있습니다.
            this.nSTATS1ETCTableAdapter.Fill(this.nSTATSDataSet.NSTATS1ETC);
            //NSTAT1();
        ...
        private void cmbCustomerSearchBinding()
{
        ...
        private String GetSelectCommand()
        {
            return @"SELECT 
                    ...
                    ,ISNULL(Customers.SangHo,Clients.Name) AS ReferralName --위탁사명
        ...
        {
            nSTATSDataSet.NSTATS1ETC.Clear();
            ...
            using (SqlConnection _Connection = new SqlConnection(Properties.Settings.Default.TruckConnectionString))
            {
                ...
                using (SqlCommand _Command = _Connection.CreateCommand())
                {
                    ...
                    {
                        nSTATSDataSet.NSTATS1ETC.Load(_Reader);
                        ...
                        if (grid1.RowCount > 0)
                        {
                            ...
                            nSTATS1ETCBindingSource_CurrentChanged(null, null);
                        }
            ...
            var Query = nSTATSDataSet.NSTATS1ETC.ToArray();

            if (Query.Any())
            {
                lblSalesPrice.Text = Query.Sum(c => c.SalesPrice).ToString("N0");
                lblAlterPrice.Text = Query.Sum(c => c.AlterPrice).ToString("N0");
                lblTotalPrice.Text = (Query.Sum(c => c.SalesPrice) + Query.Sum(c => c.AlterPrice)).ToString("N0");

                lblTradePrice.Text = Query.Sum(c => c.TradePrice).ToString("N0");
                lblAlterTradePrice.Text = Query.Sum(c => c.AlterTradePrice).ToString("N0");
                lblPrice.Text = (Query.Sum(c => c.TradePrice) + Query.Sum(c => c.AlterTradePrice)).ToString("N0");
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            f.NSTATS1(dtp_Sdate.Text, dtp_Edate.Text, jogun, nSTATS1ETCBindingSource);
        ...
        private void grid1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            var Selected = ((DataRowView)grid1.Rows[e.RowIndex].DataBoundItem).Row as NSTATSDataSet.NSTATS1ETCRow;
            ...
            else if (e.ColumnIndex == totalPriceDataGridViewTextBoxColumn.Index)
            {
                e.Value = (Selected.SalesPrice + Selected.AlterPrice).ToString("N0");
            }
        ...
        private void nSTATS1ETCBindingSource_CurrentChanged(object sender, EventArgs e)
        {
            if (nSTATS1ETCBindingSource.Current == null)
            {
                return;
            }
            else
            {
                var Selected = ((DataRowView)nSTATS1ETCBindingSource.Current).Row as NSTATSDataSet.NSTATS1ETCRow;

                GridIndex = nSTATS1ETCBindingSource.Position;
        ...
        private void btnProperty_Click(object sender, EventArgs e)
        {
         ...
         // , payLocationDataGridViewTextBoxColumn
          ...
          ,totalPriceDataGridViewTextBoxColumn
           ...
           ,alterTradeDataGridViewTextBoxColumn
