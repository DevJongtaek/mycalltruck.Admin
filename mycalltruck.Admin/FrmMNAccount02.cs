...
{
    public partial class FrmMNAccount02 : Form
    {
        int DriverId = 0;
        int CustomerId = 0;
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            List<Account02Model> T = new List<Account02Model>();
            BindingList<Account02Model> ModelDataSource = new BindingList<Account02Model>();
            if(Div.SelectedIndex == 0)
            {
                foreach (var model in ShareOrderDataSet.Trades.Where(c=>c.ClientId == LocalUser.Instance.LogInInformation.ClientId
                    ...
                    .Select(trade=> new Account02Model
                    {
                ...
                foreach (var model in ShareOrderDataSet.SalesManage.Where(c => c.ClientId == LocalUser.Instance.LogInInformation.ClientId
                    ...
                    .Select(sales => new Account02Model
                    {
