...
{
    public partial class UCAccount01 : UserControl
    {
        int DriverId = 0;
        int CustomerId = 0;
        ...
        private void UCAcoount01_Load(object sender, EventArgs e)
        {
        ...
        public void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            BindingList<UCAccount01ParentModel> ParentDataSource = new BindingList<UCAccount01ParentModel>();
            BindingList<UCAccount01Model> ModelDataSource = new BindingList<UCAccount01Model>();
            if (Div.SelectedIndex == 1)
            {
                var Query = ShareOrderDataSet.Trades.Where(c => c.ClientId == LocalUser.Instance.LogInInformation.ClientId && c.DriverId == DriverId)
                    .Select(c => new UCAccount01ParentModel
                    {
                        Id = c.TradeId,
                        Date = c.RequestDate,
                        Amount = c.Amount,
        ...
        private void ParentDataGrid_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            RequestSum.Clear();
            PaySum.Clear();
            UCAccount01ParentModel ParentModel = ParentDataGrid.Rows[e.RowIndex].DataBoundItem as UCAccount01ParentModel;
            BindingList<UCAccount01Model> ModelDataSource = new BindingList<UCAccount01Model>();
