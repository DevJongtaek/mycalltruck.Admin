...
{
    public partial class FrmMN0404_CHAGECARMANAGE_ADD : Form
    {
        int tabindex = 0;
        public FrmMN0404_CHAGECARMANAGE_ADD(int TabIndex)
        {
            InitializeComponent();
        ...
        private void _Fclear()
        {
            ...
            dtp_ApplyDate.Value = DateTime.Now;
        ...
        private void _InitCmb()
        {
            ...
            //var AccountSourceDataSource = cMDataSet.ChargeAccounts.Where(c => (c.ClientId == LocalUser.Instance.LogInInfomation.ClientId.ToString() || c.ClientId == "NULL") && (c.Gubun == cmb_Gubun2.SelectedValue.ToString() || c.Gubun == "수입/지출")&&(c.Gubun2 == 2)).Select(c => new { c.ChargeAccountId, c.Name }).OrderBy(c => c.ChargeAccountId).ToArray();
        ...
        private void _AddClient()
        {
            ...
            //   row.ChargeAccountId = int.Parse(cmb_Account.SelectedValue.ToString());
            row.ApplyDate = dtp_ApplyDate.Value.Date;
