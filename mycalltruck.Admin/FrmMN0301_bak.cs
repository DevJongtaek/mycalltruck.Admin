...
{
    public partial class FrmMN0301_bak : Form
    {
        ...
        public FrmMN0301_bak(string _mGubun = "", int _mNSTOrderId = 0, string _mCreateTime = "")
        {
        ...
        private void InitCustomerAndUsersTable()
        {
            ...
            using (SqlConnection connection = new SqlConnection(Properties.Settings.Default.TruckConnectionString))
            {
                ...
                using ( SqlCommand commnad = connection.CreateCommand())
                {
                    commnad.CommandText = "SELECT  CustomerUserId, ISNULL(LoginId,'') as LoginId, ISNULL(Password,'') as Password, ClientId, Part, Name,CreateTime" +
                        " FROM CustomerUsers " +
 ...
 || String.IsNullOrEmpty(Price1.Text) || String.IsNullOrEmpty(Item.Text))
        ...
        private void 추가운임입력ToolStripMenuItem_Click(object sender, EventArgs e)
        {
