...
{
    public partial class FrmMN0301_OverView : Form
    {
        ...
        Call24ApiClass call24ApiClass = new Call24ApiClass();
        ...
        string Call24ApiUrl = "https://api.15660088.com:18091";
        string Call24LoginId = "";
        string Call24SecretKey = "";
        string Call24EncKey = "";
        string Call24IVKey = "";
        ...
        public FrmMN0301_OverView(string _mGubun = "", int _mNSTOrderId = 0, string _mCreateTime = "")
        {
        ...
        private void FrmMN0301_Load(object sender, EventArgs e)
        {
           ...
           // ApiUrl = "http://cargo.apitest.labbgsoft.kr:8080";   //CargoQuery.Where(c => c.UseYN == "Y").First().ApiUrl;
        ...
        private void initReferralId()
        {
            ...
            customersNewTableAdapter.FillByClients(clientDataSet.CustomersNew, LocalUser.Instance.LogInInformation.ClientId, 4);
            ...
            var cmbCustomerMIdDataSource = clientDataSet.CustomersNew.Select(c => new { c.SangHo, c.CustomerId }).OrderBy(c => c.SangHo).ToArray();
            ...
            using (ShareOrderDataSet ShareOrderDataSet = new ShareOrderDataSet())
            {
                ...
                if (!String.IsNullOrEmpty(SearchText.Text))
                {
                    switch (SearchTextFilter.SelectedIndex)
                    {
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            DataSource = DataSource.Where(c => c.CustomerManager != null && c.CustomerManager.Contains(SearchText.Text)).ToList();
                            break;
                ...
                if (LocalUser.Instance.LogInInformation.ClientUserId > 0)
                {
                    ...
                    if (mTable.Any())
                    {
                        ...
                        {
                            DataSource = DataSource.Where(c => c.CustomerId == mTable.First().CustomerId && c.CustomerTeam == mTable.First().CustomerTeam).ToList();
                        }
                        else
                        {
                            DataSource = DataSource.Where(c => c.CustomerId == mTable.First().CustomerId).ToList();
        ...
        private void Customer_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            //        CustomerSelectContainer.Location = new System.Drawing.Point(91, 76);
        ...
        private void ClearStarTime_Click(object sender, EventArgs e)
        {
            ...
            // StartTimeType4.Clear();
            dtpStartTime.Value = DateTime.Now;
            //dtpStartTimeOld.Value = DateTime.Now;



            //dtpStartTime.Visible = true;
            //dtpStopTime.Visible = true;
        ...
        private void ClearStopTime_Click(object sender, EventArgs e)
        {
            ...
            StopTimeType4.Checked = false;
            dtpStopTime.Value = DateTime.Now;
            //dtpStopTimeOld.Value = DateTime.Now;
        ...
        private void _NewOrder()
        {
            ...
            StartCity.Text = "홍성군";
            StartStreet.Text = "갈산면";
            Start.Text = "산단로388번길 100 벽산홍성공장";
            StartName.Text = "충남 홍성군";
            ...
            if (mTable.Any())
            {
                ...
                Customer.Clear();
                var _Customer = CustomerModelList.Find(c => c.CustomerId == mTable.First().CustomerId);
                ...
                if(mTable.First().CustomerTeam > 0)
                {
                    cmbCustomerTeam.SelectedValue = mTable.First().CustomerTeam;
                }
                else
                {
                    cmbCustomerTeam.SelectedIndex = 0;
        ...
        private void InsertOrder_Click(object sender, EventArgs e)
        {
            ...
            //DateTime _StartTimeType = DateTime.Now;
            ...
            //    {
            //        //if (DateTime.ParseExact(DateTime.Now.ToString("yyyyMMdd"), "yyyyMMdd", null, System.Globalization.DateTimeStyles.None).Date > DateTime.ParseExact(_StartTimeType.ToString("yyyyMMdd"), "yyyyMMdd", null, System.Globalization.DateTimeStyles.None).Date)
            //        //{
            //        //    MessageBox.Show("상차일은 오늘 이후로 입력하셔야 합니다.", "차세로", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            ...
            //DateTime _StopTimeType = DateTime.Now;
            ...
            for (int i = 0; i < CarCountValue; i++)
            {
                ...
                Order nOrder = new Order
                {
                    ...
                    StopTime = dtpStopTime.Value.Date,
                ...
                else if (StartTimeType2.Checked)
                {
                    ...
                    {
                        //30분이전
                        if (dtpStartTime.Value.Minute < 30)
                ...
                else if (StartTimeType3.Checked)
                {
                    ...
                    {
                        //내일오전8시
                        nOrder.StartTime = nOrder.StartTime.Date.AddHours(8);
                    }
                ...
                else if (StopTimeType2.Checked)
                {
                    ...
                    {
                        nOrder.StopTime = nOrder.StopTime.Date.AddHours(8);
                    }
                    StopTime = "내착";
                }
                else if (StopTimeType3.Checked)
                {
                   // var MDay = DateTime.Now.Date.AddDays(Convert.ToInt32(DayOfWeek.Monday) - Convert.ToInt32(DateTime.Today.DayOfWeek)).AddDays(7);

                    nOrder.StopTimeType = 3;
                    nOrder.StopTime = _StopTimeType.Date;// MDay;//nOrder.StartTime.Date;
                    if (StopTimeHour1.SelectedIndex > 0 && StopTimeHour2.SelectedIndex > 0)
                    {
                        nOrder.StopTimeHour = StopTimeHour2.SelectedIndex + (StopTimeHour1.SelectedIndex - 1) * 12;
                        nOrder.StopTime = nOrder.StopTime.AddHours(nOrder.StopTimeHour.Value);
                ...
                else if (StopTimeType4.Checked)
                {
                    ...
                    nOrder.StopTime = _StopTimeType.AddHours(6);
                    StopTime = "당착/내착";
                }
                else if (!StopTimeType1.Checked && !StopTimeType2.Checked && !StopTimeType3.Checked && !StopTimeType4.Checked)
                {
                ...
                if (LocalUser.Instance.LogInInformation.Client.CargoApiYn)
                {
                    ...
                    else
                    {
                        ...
                        int _Orderid = nOrder.OrderId;
                        string CargoGubun = "등록";
                        string result;
                       // var _CargoAddrSearch = cargoDataSet.CargoApiAdress.ToArray();
                        var _CargoAddrSearch = cargoDataSet.CargoApiAdressNew.ToArray();
                        ...
                        using (ShareOrderDataSet ShareOrderDataSet = new ShareOrderDataSet())
                        {
                            ...
                            if (_AddressGubun != "S")
                            {
                                if (string.IsNullOrEmpty(CargoOrder.StartStreet))
                                {

                                }
                                else
                                {
                                    //if (CargoOrder.StartStreet.Substring(CargoOrder.StartStreet.Length - 1) != "구")
                                    //{
                                        //20210119
                                        var _Addr = CargoOrder.StartState + " " + CargoOrder.StartCity + " " + CargoOrder.StartStreet + " " + CargoOrder.StartDetail;

                                        var _Addrs = _Addr.Split(' ');

                                        if (_Addrs.Length > 3)
                                        {
                                            _StartStreet = cargoApiClass.roadaddr_trans(_Addrs[0] + " " + _Addrs[1] + " " + _Addrs[2] + " " + _Addrs[3]);
                                        }
                                        else
                                        {
                                            _StartStreet = cargoApiClass.roadaddr_trans(CargoOrder.StartState + " " + CargoOrder.StartCity + " " + CargoOrder.StartStreet);
                                        }
                                    //}
                                    //else
                                    //{ }
                                }
                               //+ " " + CargoOrder.StartDetail);
                            }
                            else
                            {
                                if (!string.IsNullOrWhiteSpace(CargoOrder.StartStreet))
                                {
                            ...
                            if (string.IsNullOrEmpty(_StartStreet))
                            {
                                ...
                                if (!string.IsNullOrEmpty(EditStartStreet))
                                {
                                    ...
                                    if (CargoOrder.StartStreet.Substring(CargoOrder.StartStreet.Length - 1) == "구")
                                    {
                                        ...
                                        EditStartStreet = EditStartStreet.Substring(0, EditStartStreet.Length - 1);
                                    }
                                   
                                }
                                
                                //화물맨주소검색
                                var _Q = _CargoAddrSearch.Where(c => c.SIDO + "" + c.GU + "" + c.GUN + "" + c.DONG == _AddressStateParse(CargoOrder.StartState) + "" + (CargoOrder.StartCity) + "" + EditStartStreet);
                            ...
                            else
                            {
                                ...
                                if (!String.IsNullOrEmpty(startaddr1))
                                {
                                    ...
                                    startaddr3 = cargoApiClass.get_address_search(_AddressStateParseNew(CargoOrder.StartState) + "" + _startcity + "" + _StartDetail, _StartDetail, ApiUrl);
                            ...
                            if (_AddressGubun != "S")
                            {
                                if (string.IsNullOrEmpty(CargoOrder.StopStreet))
                                {

                                }
                                else
                                {
                                    //if (CargoOrder.StopStreet.Substring(CargoOrder.StopStreet.Length - 1) != "구")
                                    //{

                                        //20210119
                                        var _Addr = CargoOrder.StopState + " " + CargoOrder.StopCity + " " + CargoOrder.StopStreet + " " + CargoOrder.StopDetail;

                                        var _Addrs = _Addr.Split(' ');

                                        if (_Addrs.Length > 3)
                                        {
                                            _Stopstreet = cargoApiClass.roadaddr_trans(_Addrs[0] + " " + _Addrs[1] + " " + _Addrs[2] + " " + _Addrs[3]);
                                        }
                                        else
                                        {
                                            _Stopstreet = cargoApiClass.roadaddr_trans(CargoOrder.StopState + " " + CargoOrder.StopCity + " " + CargoOrder.StopStreet);
                                        }
                            ...
                            else
                            {
                                ...
                                {
                                    if (!string.IsNullOrWhiteSpace(CargoOrder.StopStreet))
                                    {
                                        //_Stopstreet = cargoApiClass.roadaddr_trans(CargoOrder.StopState + " " + CargoOrder.StopCity + " " + CargoOrder.StopStreet);
                            ...
                            if (string.IsNullOrEmpty(_Stopstreet))
                            {
                                ...
                                if (!string.IsNullOrEmpty(EditStopStreet))
                                {
                                    ...
                                    if (CargoOrder.StopStreet.Substring(CargoOrder.StopStreet.Length - 1) == "구")
                                    {
                                        ...
                                        EditStopStreet = EditStopStreet.Substring(0, EditStopStreet.Length - 1);
                                    }
                                }
                                

                                //화물맨주소검색
                                var _Q = _CargoAddrSearch.Where(c => c.SIDO + "" + c.GU + "" + c.GUN + "" + c.DONG == _AddressStateParse(CargoOrder.StopState) + "" + (CargoOrder.StopCity) + "" + EditStopStreet);
                                //var _Q = _CargoAddrSearch.Where(c => c.SIDO + "" + c.GU + "" + c.GUN + "" + c.DONG == _AddressStateParseNew(CargoOrder.StopState) + "" + CargoOrder.StopCity + "" + EditStopStreet);
                            ...
                            else
                            {
                                if (!string.IsNullOrEmpty(_Stopstreet))
                                {
                                    ...
                                    if (_StopCitys.Length == 3)
                                    {
                                        ...
                                        //_stopcity = _StopCitys[0] + _StopCitys[1];
                                ...
                                {
                                    if (_stopcity.Contains("고양일산"))
                                    {
                                        _stopcity = "고양일산";
                                    }
                                    // startaddr2 = cargoApiClass.get_addr_search2(startaddr1, _startcity);
                                    stopaddr3 = cargoApiClass.get_address_search(_AddressStateParseNew(CargoOrder.StopState) + "" + _stopcity + "" + _StopDetail, _StopDetail, ApiUrl);
                            ...
                            var PAYMENT = "";
                                ...
                                try
                                {
                                    ...
                                    if (code == "200")
                                    {
                                        ...
                                        {
                                            CargoApiMessageBox cargoApiMessageBox = new CargoApiMessageBox($"\"화물맨\"에 {CargoGubun}되었습니다");

                                            cargoApiMessageBox.ShowDialog();
                                            //MessageBox.Show(new Form { TopMost = true }, $"\"화물맨\"에 {CargoGubun}되었습니다", "화물맨 연동", MessageBoxButtons.OK);
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            CargoApiMessageBox cargoApiMessageBox = new CargoApiMessageBox($"{msg}");
     ...
     || String.IsNullOrEmpty(Price1.Text) || String.IsNullOrEmpty(Item.Text))
            ...
            using (ShareOrderDataSet ShareOrderDataSet = new ShareOrderDataSet())
            {
                ...
                uOrder.IsShore = true;
                if (uOrder.CustomerTeam == null)
                {
                    uOrder.CustomerTeam = 0;
                }
                if (PayLocation.SelectedIndex == 2)
                {
                ...
                {
                   // var MDay = DateTime.Now.Date.AddDays(Convert.ToInt32(DayOfWeek.Monday) - Convert.ToInt32(uOrder.StopTime.DayOfWeek)).AddDays(7);

                    uOrder.StopTimeType = 3;
                    uOrder.StopTime = _StopTimeType.Date;//uOrder.StartTime;
                    if (StopTimeHour1.SelectedIndex > 0 && StopTimeHour2.SelectedIndex > 0)
                    {
                        uOrder.StopTimeHour = StopTimeHour2.SelectedIndex + (StopTimeHour1.SelectedIndex - 1) * 12;
                        uOrder.StopTime = uOrder.StopTime.AddHours(uOrder.StopTimeHour.Value);
                    ...
                    else
                    {
                        uOrder.StopTimeHour = null;
                        uOrder.StopTimeHalf = null;
                        uOrder.StopTime = _StopTimeType.AddHours(8);
                    }
                }
                else if (StopTimeType4.Checked)
                {
        ...
        private void DataList_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            if (e.RowIndex > -1 && e.RowIndex < DataListSource.Count)
            {
                ...
                {
                    if (Current.CustomerTeam != 0 && Current.CustomerTeam != null )
                    {
                        string R = "";
                        using (SqlConnection _Connection = new SqlConnection(Properties.Settings.Default.TruckConnectionString))
                        {
                ...
                {
                    e.Value = Current.SalesPrice + Current.AlterPrice + Current.StartPrice + Current.StopPrice;
                }

                else if(e.ColumnIndex == ColumnCustomerManager.Index)
                {
                    e.Value = Current.CustomerManager;
                }
  ...
  || String.IsNullOrEmpty(Price1.Text) || String.IsNullOrEmpty(Item.Text))
                            ...
                            try
                            {
                                ...
                                using (StreamReader reader = new StreamReader(httpResponse.GetResponseStream()))
                                {
                                    ...
                                    if (code == "200")
                                    {
                                        ...
                                        CargoApiMessageBox cargoApiMessageBox = new CargoApiMessageBox($"\"화물맨\"에 재접수 되었습니다");
                                    ...
                                    else
                                    {
                                        ...
                                        CargoApiMessageBox cargoApiMessageBox = new CargoApiMessageBox($"\"화물맨\"에 재접수 실패되었습니다");
        ...
        private void ModelToView(Order Current)
        {
            ...
            var _Total = Current.StopPrice + Current.StartPrice + Current.SalesPrice + Current.AlterPrice;
            TotalPrice.Text = (_Total ?? 0).ToString("N0");
            ...
            //dtpStartTimeOld.Value = Current.StartTime;
            ClearStopTime_Click(null, null);
            ...
            //dtpStopTimeOld.Value = Current.StopTime;
   ...
   || String.IsNullOrEmpty(Price1.Text) || String.IsNullOrEmpty(Item.Text))
        ...
        private void DataList_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (e.ColumnIndex == btnSms.Index)
            {
                ...
                Message = $"{DriverName.Text} 님께서 배차 신청하신 {DriverCarNo.Text} 차량으로 배차처리가 완료되었습니다. 안전운전하시기 바랍니다." + "\r\n" +
                              ...
                              $"{LocalUser.Instance.LogInInformation.ClientName } / {StartPhoneNo.Text}" + "\r\n" +
                              $"{_StartMemo}" + "\r\n" +
                               "■ 하차지" + "\r\n" +
                              $"{StopState.Text} {StopCity.Text} {StopStreet.Text} {Stop.Text}" + "\r\n" +
                              $"{_StopPhoneNo}" + "\r\n" +
        ...
        private string _AddressStateParseNew(String _Value)
        {
            string R = "";
            switch (_Value)
            {
        ...
        public void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < grid1.ColumnCount; i++)
            {
                if (grid1.Columns[i].Visible && !(new DataGridViewColumn[] { CustomerSms, btnSms, lMsCntCol }.Contains(grid1.Columns[i])))
                {
                    ColumnIndexMap.Add(ColumnIndex, i);
                    ColumnIndex++;
                }
        ...
        private int _NewDriver24(string DriverName,string DriverMobileNo,string DriverCarNo,int CarSize,int CarType)
        {
            DriverRepository mDriverRepository = new DriverRepository();
            if (mDriverRepository.GetDriver(NewCarNo.Text) == null)
            {
                int DriverId = mDriverRepository.CreateSmartDriver(DriverName, DriverMobileNo, DriverCarNo, CarSize, CarType, out String LoginId, out String Password, 0);
                DriverModelList.Add(new DriverModel
                {
                    DriverId = DriverId,
                    CarNo = NewCarNo.Text,
 ...
 || String.IsNullOrEmpty(Price1.Text) || String.IsNullOrEmpty(Item.Text))
                ...
                if (DataSource.Any())
                {
                    ...
                    if (DataSource.First().ClientId == LocalUser.Instance.LogInInformation.ClientId && _MyOrder)
                    {
                        if (DataSource.First().CustomerId != null && !string.IsNullOrEmpty(DataSource.First().Customer))
                        {
                            ...
                            _InitCustomerTeam(DataSource.First().CustomerId ??0);
                        }
                        else
                        {
                            Customer.Tag = null;
        ...
        private void btnPause_Click(object sender, EventArgs e)
        {
            ...
            else
            {
             ...
             || String.IsNullOrEmpty(Item.Text))
                ...
                //    if (DateTime.TryParse(_DStopTimeType, out _StopTimeType))
                //    {
                //        //if (DateTime.ParseExact(DateTime.Now.ToString("yyyyMMdd"), "yyyyMMdd", null, System.Globalization.DateTimeStyles.None).Date > DateTime.ParseExact(_StopTimeType.ToString("yyyyMMdd"), "yyyyMMdd", null, System.Globalization.DateTimeStyles.None).Date)
                //        //{
                //        //    MessageBox.Show("하차일은 오늘 이후로 입력하셔야 합니다.", "차세로", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                //        //    StopTimeType5.Focus();
                //        //    return;
                ...
                for (int i = 0; i < CarCountValue; i++)
                {
                    ...
                    if (nOrder.CustomerTeam == null)
                    {
                        nOrder.CustomerTeam = 0;
                    }
                    //선착불
                    if (PayLocation.SelectedIndex == 2)
                    {
                    ...
                    else
                    {
                        ...
                        if (DateTime.Now.Minute < 30)
                        {
                            nOrder.StartTime = Convert.ToDateTime(DateTime.Now.ToString("yyyy-MM-dd HH:mm"));
                        }
                        else
                        {
                            nOrder.StartTime = Convert.ToDateTime(DateTime.Now.AddHours(1).ToString("yyyy-MM-dd HH:mm"));
                        }
                    ...
                    else if (StopTimeType3.Checked)
                    {
                       // var MDay = DateTime.Now.Date.AddDays(Convert.ToInt32(DayOfWeek.Monday) - Convert.ToInt32(DateTime.Today.DayOfWeek)).AddDays(7);
                        ...
                        {
                            nOrder.StopTime = _StopTimeType.AddHours(8);
                        }
                        StopTime = "월착";
                    }
                    else if (StopTimeType4.Checked)
        ...
        private void setCargoRegist(string CargoGubun, int _Orderid = 0, int _CarCountValue = 0, int _i = 0)
        {
            ...
            using (ShareOrderDataSet ShareOrderDataSet = new ShareOrderDataSet())
            {
                ...
                if (string.IsNullOrEmpty(_StartStreet))
                {
                    ...
                    //var _Q = _CargoAddrSearch.Where(c => c.SIDO + "" + c.GU + "" + c.GUN + "" + c.DONG == _AddressStateParseNew(CargoOrder.StartState) + "" + CargoOrder.StartCity + "" + EditStartStreet.Trim());
                ...
                else
                {
                    if (!string.IsNullOrEmpty(_StartStreet))
                    {
                        ...
                        if (_StartCitys.Length == 3)
                        {
                            ...
                            //}
                            _startcity = _AddressCityParse(_StartCitys[0]) + _StartCitys[1];
                            //_startcity = _StartCitys[0] + _StartCitys[1];
        ...
        private void CallPass24OldToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //상차일시
            SendTextToAnotherApplication.SetText(5, dtpStartTime.Value.Date.ToString());
            //하차일시
            SendTextToAnotherApplication.SetText(4, dtpStopTime.Value.Date.ToString());
            //의뢰자명
        ...
        private void CallPass24NewToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //SendTextToAnotherApplication.SetText(10, Item.Text);
            //상차일시
            SendTextToAnotherApplication.SetText(5, dtpStartTime.Value.Day.ToString());
            //하차일시
            SendTextToAnotherApplication.SetText(4, dtpStopTime.Value.Day.ToString());
            //의뢰자명
        ...
        private void dtpStopTime_ValueChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    var Current = DataListSource.Current as Order;
            //    if (Current.StartTime.Date != dtpStartTime.Value.Date)
            //    {
            //        StopTimeType1.Checked = false;
            //        StopTimeType2.Checked = false;
            //        StopTimeType3.Checked = false;
        ...
        private void dtpStartTime_ValueChanged(object sender, EventArgs e)
        {
                ...
                //if (StartTimeType1.Checked || StartTimeType2.Checked || StartTimeType3.Checked)
                //{
                //    if (dtpStartTime.Value.Date != dtpStartTimeOld.Value.Date)
                //    {
                //        StartTimeType1.Checked = false;
                //        StartTimeType2.Checked = false;
                //        StartTimeType3.Checked = false;
        ...
        private void setCall24Regist(string CargoGubun, string _Call24ordNo , int _Orderid = 0, int _CarCountValue = 0, int _i = 0)
        {
            LocalUser.Instance.LogInInformation.LoadClient();
            Call24LoginId = LocalUser.Instance.LogInInformation.Client.Call24LoginId;
            Call24SecretKey = LocalUser.Instance.LogInInformation.Client.Call24SecretKey;
            Call24EncKey = LocalUser.Instance.LogInInformation.Client.Call24EncKey;
            Call24IVKey = LocalUser.Instance.LogInInformation.Client.Call24IVKey;


            if (string.IsNullOrEmpty(Call24LoginId) || string.IsNullOrEmpty(Call24SecretKey) || string.IsNullOrEmpty(Call24EncKey) || string.IsNullOrEmpty(Call24IVKey))
            {
                MessageBox.Show("내정보에 24시콜 정보를 등록하세요.");
            ...
            using (ShareOrderDataSet ShareOrderDataSet = new ShareOrderDataSet())
            {
                 var CargoOrder = ShareOrderDataSet.Orders.Where(c => c.OrderId == _Orderid).FirstOrDefault();

                var multiCargoGub = "";
                var urgent = "";
                var shuttleCargoInfo = "";
                //  var OWID = LocalUser.Instance.LogInInformation.Client.CargoLoginId;  //"화물맨";
                var PAYMENT = "";
                var cargoTon = "";
                var truckType = "";
                ...
                else if (CarSize.Text == "5톤플러스")
                {
                    cargoTon = "5";
                }

                else if (CarSize.Text == "5톤축")
                {
                    cargoTon = "5";
                }
                else if (CarSize.Text == "9.5")
                {
                    cargoTon = "11";
                }
                else if (CarSize.Text == "추레라")
                {
                    cargoTon = "";
                }
                else if (CarSize.Text == "1톤미만")
                {
                    cargoTon = "0.1";
                }
                else
                {
                    cargoTon = CarSize.Text;
                }
                ...
                if(CargoOrder.StartTime.Date < DateTime.Now.Date)
                {
                    CargoOrder.StartTime = DateTime.Now.Date;
                }

                if (CargoOrder.StopTime.Date < DateTime.Now.Date)
                {
                    CargoOrder.StopTime = DateTime.Now.Date;
                }

                if(int.Parse(Price1.Text.Replace(",", "")) < 20000)
                {
                    MessageBox.Show("최저 운송료는 20,000원 입니다.");
                    return;
                ...
                #region 등록
                string jsonOrderAdd = "{" +
                                       "\"startWide\":\"" + _AddressStateParse(CargoOrder.StartState) + "\"" +
                                       ",\"startSgg\":\"" + _AddressCityParse24(CargoOrder.StartCity) + "\"" +
                                       ",\"startDong\":\"" + CargoOrder.StartStreet + "\"" +
                                       ",\"startDetail\":\"" + CargoOrder.StartDetail + "\"" +

                                       ",\"endWide\":\"" + _AddressStateParse(CargoOrder.StopState) + "\"" +
                                       ",\"endSgg\":\"" + _AddressCityParse24(CargoOrder.StopCity) + "\"" +
                                       ",\"endDong\":\"" + CargoOrder.StopStreet + "\"" +
                                       ",\"endDetail\":\"" + CargoOrder.StopDetail + "\"" +


                                       ",\"multiCargoGub\":\"" + multiCargoGub + "\"" +
                                       ",\"urgent\":\"" + urgent + "\"" +
                                       ",\"shuttleCargoInfo\":\"" + shuttleCargoInfo + "\"" +

                                        ",\"cargoTon\":\"" + cargoTon + "\"" +
                                        ",\"truckType\":\"" + CarType.Text + "\"" +
                                         ",\"frgton\":\"" + WEIGHT + "\"" +

                                       ",\"startPlanDt\":\"" + CargoOrder.StartTime.ToString("yyyyMMdd") + "\"" +
                                       ",\"endPlanDt\":\"" + CargoOrder.StopTime.ToString("yyyyMMdd") + "\"" +
                                       ",\"startLoad\":\"" + StartInfo + "\"" +
                                       ",\"endLoad\":\"" + StopInfo + "\"" +

                                       ",\"cargoDsc\":\"" + CargoOrder.Item + "\"" +
                                       ",\"farePaytype\":\"" + farePaytype + "\"" +


                                       ",\"fare\":\"" + Price1.Text.Replace(",","") + "\"" +
                                       ",\"fee\":\"" + Price6.Text.Replace(",", "") + "\"" +
                                       ",\"endAreaPhone\":\"" + StopPhoneNo.Text + "\"" +
                                      
                                        ",\"firstType\":\"01\"" +
                                        ",\"firstShipperNm\":\"" + LocalUser.Instance.LogInInformation.Client.Name + "\"" +
                                        ",\"firstShipperInfo\":\"" + LocalUser.Instance.LogInInformation.Client.PhoneNo.Replace("-","") + "\"" +
                                        ",\"firstShipperBizNo\":\"" + LocalUser.Instance.LogInInformation.Client.BizNo.Replace("-", "") + "\"" +
                                          ",\"taxbillType\":\"N\"" +
                                          ",\"payPlanYmd\":\"\"" +
                                          ",\"ddID\":\"\"" +
                ...
                if (CargoGubun == "수정")
                {
                    _data = call24ApiClass.AESEncrypt(jsonOrderUpdate, Call24SecretKey, Call24EncKey, Call24IVKey);
                    url = $"{Call24ApiUrl}/api/order/modOrder";
                }
                else
                {
                    _data = call24ApiClass.AESEncrypt(jsonOrderAdd, Call24SecretKey, Call24EncKey, Call24IVKey);
                    url = $"{Call24ApiUrl}/api/order/addOrder";
                }
                ...
                try
                {
                    ...
                    request.ContentType = "application/json";
                    request.Method = "POST";
                    request.Headers.Add("call24-api-key:"+Call24SecretKey+"");
                    ...
                    using (StreamReader reader = new StreamReader(httpResponse.GetResponseStream()))
                    {
                        ...
                        if (code == "1")
                        {
                            ...
                            if (_Array.data != null)
                            {
                                ...
                                dataArray = call24ApiClass.AESDecrypt(Convert.ToString(dataArray), Call24SecretKey, Call24EncKey, Call24IVKey);

                                var JData = JObject.Parse(dataArray);


                                var orderNo = JData["ordNo"].ToString();
                                ...
                                Data.Connection(_Connection =>
                                {
                                    using (SqlCommand _Command = _Connection.CreateCommand())
                                    {
                                        _Command.CommandText = "Update Orders SET Call24ApiYN = 'Y' , Call24ApiStatus = @CargoGubun, Call24OrdNo = @Call24OrdNo WHERE OrderId = @OrderId ";

                                        _Command.Parameters.AddWithValue("@OrderId", CargoOrder.OrderId);
                                        _Command.Parameters.AddWithValue("@CargoGubun", CargoGubun);
                                        _Command.Parameters.AddWithValue("@Call24OrdNo", orderNo);
                                ...
                                if (String.IsNullOrEmpty(CargoStatus))
                                {
                                    CargoApiMessageBox cargoApiMessageBox = new CargoApiMessageBox($"\"24시콜\"에 {CargoGubun}되었습니다");
        ...
        /// <param name="e"></param>
        private void Call24toolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (DataListSource.Current != null && DataListSource.Current is Order Current)
            {
                if (Current.OrderStatus == 3)
                ...
                {
                    if (Current.Call24ApiYN != "Y" && Current.Call24ApiStatus !="등록" && string.IsNullOrEmpty(Current.Call24ordNo))
                    {

                        setCall24Regist("등록", "", Current.OrderId);


                    }
                    else if (Current.Call24ApiYN == "Y" && Current.Call24ApiStatus != "취소" && !string.IsNullOrEmpty(Current.Call24ordNo))
                    {
                        setCall24Regist("수정", Current.Call24ordNo, Current.OrderId);
        ...
        {
            bool aa = true;
           // aa = call24ApiClass.get_address_search(_AddressStateParse(StartState.Text), _AddressCityParse24( StartCity.Text),StartStreet.Text, Call24ApiUrl);
        ...
        //24시 내역 가져오기
        private void Call24InfotoolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (DataListSource.Current != null && DataListSource.Current is Order Current)
            {
                Call24Import(Current.Call24ordNo);
            }
        }

        private void Call24Import(string ordNo)
        {
            LocalUser.Instance.LogInInformation.LoadClient();
            Call24LoginId = LocalUser.Instance.LogInInformation.Client.Call24LoginId;
            Call24SecretKey = LocalUser.Instance.LogInInformation.Client.Call24SecretKey;
            ...
            using (ShareOrderDataSet ShareOrderDataSet = new ShareOrderDataSet())
            {
                ...
                string url = "";
                _data = call24ApiClass.AESEncrypt(jsonordNo, Call24SecretKey, Call24EncKey, Call24IVKey);
                url = $"{Call24ApiUrl}/api/order/getOrder";
                //string json = "{\"data\":\"\",\"userVal\":\"test\"}";
                string json = "{\"data\":\"" + _data + "\",\"userVal\":\"test\"}";
                JObject response = null;
                try
                {
                    ...
                    using (StreamReader reader = new StreamReader(httpResponse.GetResponseStream()))
                    {
                        ...
                        if (code == "1")
                        {
                            ...
                            if (_Array.data != null)
                            {
                                ...
                                JArray jArray = JArray.Parse(dataArray);

                                dynamic JData = null;
                                for (int i = 0;i< jArray.Count;i++)
                                {
                                    JData = JObject.Parse(jArray[i].ToString());
                                ...
                                var orderNo = JData["ordNo"].ToString();
                                //차주명
                                var cjName = JData["cjName"].ToString();
                                //차주사업자번호
                                var cjBizNo = JData["cjBizNo"].ToString();
                                //차주연락처
                                var cjPhone = JData["cjPhone"].ToString();
                                //차량번호
                                var cjCarNum = JData["cjCarNum"].ToString();
                                //차량톤수
                                var cjCargoTon = JData["cjCargoTon"].ToString();
                                //차량종류
                                var cjTruckType = JData["cjTruckType"].ToString();
                                //계산서발행금액
                                var cjTaxAmount = JData["cjTaxAmount"].ToString();
                                //계산서발행일
                                var cjTaxDt = JData["cjTaxDt"].ToString();
                                int iReferralId = 0;

                                
                                if (!String.IsNullOrEmpty(cjName) && !String.IsNullOrEmpty(cjCarNum))
                                {
                                    int _CarType = 99;
                                    int _CarSize = 99;
                                    var _CarTypeList = SingleDataSet.Instance.StaticOptions.Where(c => c.Div == "CarType" && c.Name == cjTruckType).ToArray();

                                    var _CarSizeList = SingleDataSet.Instance.StaticOptions.Where(c => c.Div == "CarSize" && c.Name == cjTruckType).ToArray();

                                    if (_CarTypeList.Any())
                                    {
                                        _CarType = _CarTypeList.First().Value;
                                    }

                                    if (_CarSizeList.Any())
                                    {
                                        _CarSize = _CarSizeList.First().Value;
                                    }

                                    int _DriverId = _NewDriver24(cjName, cjPhone, cjCarNum, _CarSize, _CarType);
                                    if (_DriverId == 0)
                                    {

                                        _DriverId = DriverModelList.Find(c => c.CarNo == NewCarNo.Text).DriverId;

                                    }
                                    
                                    

                                    var _ReferralId = CustomerModelList.Where(c => c.SangHo.Contains("24시콜화물")).ToArray();

                                    if(_ReferralId.Any())
                                    {
                                        iReferralId = _ReferralId.FirstOrDefault().CustomerId;
                                    }
                                    //24시콜 OrdNo 업데이트
                                    Data.Connection(_Connection =>
                                    {
                                        using (SqlCommand _Command = _Connection.CreateCommand())
                                        {
                                            _Command.CommandText = "Update Orders SET ReferralId = @ReferralId,AcceptTime = getdate(),DriverId = @DriverId,DriverCarModel = @DriverName,DriverCarNo = @DriverCarNo,DriverPhoneNo = @DriverPhoneNo,OrderStatus = 3,Wgubun = 'CARGO',Call24ApiStatus = '완료' WHERE Call24OrdNo = @Call24OrdNo ";


                                            _Command.Parameters.AddWithValue("@ReferralId", iReferralId);
                                            _Command.Parameters.AddWithValue("@DriverId", _DriverId);
                                            _Command.Parameters.AddWithValue("@DriverName", cjName);
                                            _Command.Parameters.AddWithValue("@DriverCarNo", cjCarNum);

                                            _Command.Parameters.AddWithValue("@DriverPhoneNo", cjPhone);
                                    ...
                                    try
                                    {
                                            ...
                                            CargoApiMessageBox cargoApiMessageBox = new CargoApiMessageBox($"\"24시콜\"정보갱신 되었습니다");
                                ...
                                else
                                {
                                    try
                                    {
                                         CargoApiMessageBox cargoApiMessageBox = new CargoApiMessageBox($"\"24시콜\"갱신 정보가 없습니다.");
        ...
        private void Call24AllImport()
        {
            ...
            using (ShareOrderDataSet ShareOrderDataSet = new ShareOrderDataSet())
            {
                ...
                string url = "";
                //_data = call24ApiClass.AESEncrypt(jsonordNo, Call24SecretKey, Call24EncKey, Call24IVKey);
                url = $"{Call24ApiUrl}/api/order/getOrderAll";
                //string json = "{\"data\":\"\",\"userVal\":\"test\"}";
                string json = "{\"data\":\"\",\"userVal\":\"test\"}";
                JObject response = null;
                try
                    ...
                    using (StreamReader reader = new StreamReader(httpResponse.GetResponseStream()))
                    {
                        ...
                        if (code == "1")
                        {
                            ...
                            if (_Array.data != null)
                            {
                                ...
                                if (JData == null)
                                {
                                    MessageBox.Show("당일 등록 화물이 없습니다.");
                                    return;
                                }
                                else
                                {
