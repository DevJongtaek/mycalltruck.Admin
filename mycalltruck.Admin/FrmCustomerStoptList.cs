...
{
    public partial class FrmCustomerStoptList : Form
    {
        int _CustomerId = 0;
        public FrmCustomerStoptList()
        {
            InitializeComponent();
        }
...
UNION  
SELECT  idx, StartState, StartCity, StartStreet, StartDetail, StartName, StartPhoneNo, ClientId, CustomerId, CreateTime,'추가' as Gubun FROM CustomerStartManage WHERE SGubun = 'E')A
        ...
        private void newDGV1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            {
                var Selected = ((DataRowView)newDGV1.Rows[e.RowIndex].DataBoundItem).Row as CustomerStartManageDataSet.CustomerStopManageRow;
        ...
        {
           // var Selected = ((DataRowView)newDGV1.SelectedRows[0].DataBoundItem).Row as SalesDataSet.SalesManageRow;
            var _Model = customerStartManageDataSet.CustomerStopManage[RowIndex];
