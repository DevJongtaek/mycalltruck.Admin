...
{
    public partial class UCSTATS6 : UserControl
    {
        public UCSTATS6()
        {
            InitializeComponent();
        ...
        private void UCSTATS6_Load(object sender, EventArgs e)
        {
            dtp_Sdate.Value = DateTime.Now.AddMonths(-3);
            dtp_Edate.Value = DateTime.Now;
            this.sTATS6TableAdapter.Fill(cMDataSet.STATS6, dtp_Sdate.Value, dtp_Edate.Value, LocalUser.Instance.LogInInformation.ClientId);
        }
        ...
        private void btn_Print_Click(object sender, EventArgs e)
        {
            ...
            f.STATS6(dtp_Sdate.Text, dtp_Edate.Text, order, sTATS6BindingSource);
