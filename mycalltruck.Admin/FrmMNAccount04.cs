...
{
    public partial class FrmMNAccount04 : Form
    {
        int DriverId = 0;
        int CustomerId = 0;
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            List<Account04Model> T = new List<Account04Model>();
            BindingList<Account04Model> ModelDataSource = new BindingList<Account04Model>();
            ...
            if (Div.SelectedIndex == 0)
            {
                ...
                {
                    ModelDataSource.Add(new Account04Model
                    {
                        Id = group.Key.Id,
                        Name = group.Key.Name,
                        Date = group.Key.Date,
        ...
        private void ModelDataGrid_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            {
                var Model = ModelDataGrid.Rows[e.RowIndex].DataBoundItem as Account04Model;
                if (Model.IsMonth)
                {
