...
{
    public partial class UCAccount06 : UserControl
    {
        int DriverId = 0;
        int CustomerId = 0;
        ...
        private void UCAccount06_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            List<UCAccount06Model> T = new List<UCAccount06Model>();
            BindingList<UCAccount06Model> ModelDataSource = new BindingList<UCAccount06Model>();
            ...
            {
                ModelDataSource.Add(new UCAccount06Model
                {
                    Id = group.Key.Id,
                    Name = group.Key.Name,
