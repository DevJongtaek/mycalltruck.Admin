...
{
    public partial class UCAccount03 : UserControl
    {
        int DriverId = 0;
        int CustomerId = 0;
        ...
        private void UCAccount03_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            List<UCAccount03Model> T = new List<UCAccount03Model>();
            BindingList<UCAccount03Model> ModelDataSource = new BindingList<UCAccount03Model>();
            if (Div.SelectedIndex == 0)
            {
                if (LocalUser.Instance.LogInInformation.Client.StaticFromOrder)
                {
                    ...
                    foreach (var model in Query
                        .Select(group => new UCAccount03Model
                        {
